...
public class Terrain : IndexVertexBuffers {
   ...
   public Terrain(Stage theStage, string label, string heightFile, string colorFile) 
      ...
      for (int z = 0; z < height; z++)
         for (int x = 0; x < width; x++)  {
			...
			vertexHeight = (int) (vector4.X * -255);   // scale vertexHeight 0..255 (Changed to negative to get craters and canyons instead of hills - by David Kopp)
   ...
   /// </summary> (might want to edit here for lerp)
