...
public class NPAgent : Agent {
   private bool treasurePathing; // new added
   private bool aStarDone; // new added
   private NavGraph graph; // new added
   ...
   private NavNode scanTemp; // new Added
   private Path path;
   private int snapDistance = 200;  // this should be a function of step and stepSize
